    ...
    <>
      ...
      <MenuInnerWithSub title='Apps' to='/apps' menuPlacement='bottom-start' menuTrigger='click'>
        ...
        <MenuInnerWithSub
          ...
          menuTrigger={`{default:'click', lg: 'hover'}`}
        >
          <MenuItem to='/apps/chat/partner' title='Private Chat' hasBullet={true} />
          <MenuItem to='/apps/chat/user' title='Group Chart' hasBullet={true} />
          <MenuItem to='/apps/chat/edit' title='Drawer Chart' hasBullet={true} />
        </MenuInnerWithSub>
        <MenuItem

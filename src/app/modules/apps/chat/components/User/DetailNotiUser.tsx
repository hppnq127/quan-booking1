...
import { NotiType } from '../Partner/components/NotiType'
import { SendTo } from '../Partner/components/SendTo'
import { NotiDetail } from '../Partner/DetailNotiPartner'

import '../Partner/NotiPartner.scss'
export const DetailNotiUser = () => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className='body'>
               <SendTo name='khách hàng' loading={loading} data={infoNoti}/>
        </div>
        <div className='body'>
